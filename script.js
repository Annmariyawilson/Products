PRODUCTS=[
  ...
  PRODUCTS.forEach(item => {
      e += `
  <div class="card col-4 p-4" style="width: 17rem;">
  <i class="fa-solid fa-heart" style="color: #d7d8da;"></i>
        <img src=${item.image} class="container mt-3" alt='img' height='200px' width='200px'>
  ...
  <a href="#" class="btn btn-success">${item.price}</a>
      <a href="#" class="btn"><i class="fa-solid fa-star fa-sm" style="color: #FFD43B;"></i> ${item.rating.rate}</a>
